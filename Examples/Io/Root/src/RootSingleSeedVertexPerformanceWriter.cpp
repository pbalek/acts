...
#include "ActsExamples/Io/Root/RootSingleSeedVertexPerformanceWriter.hpp"
...
ActsExamples::RootSingleSeedVertexPerformanceWriter::RootSingleSeedVertexPerformanceWriter(
    const ActsExamples::RootSingleSeedVertexPerformanceWriter::Config& config,
    Acts::Logging::Level level)
    : WriterT(config.inputVertices, "RootSingleSeedVertexPerformanceWriter", level),
      m_cfg(config) {
  ...
  if (m_outputTree == nullptr) {
    ...
    m_outputTree->Branch("nearSPNum", &m_nearSPNum);
    m_outputTree->Branch("middleSPNum", &m_middleSPNum);
    m_outputTree->Branch("farSPNum", &m_farSPNum);
    m_outputTree->Branch("tripletNum", &m_tripletNum);
  }
}

ActsExamples::RootSingleSeedVertexPerformanceWriter::
...
ActsExamples::RootSingleSeedVertexPerformanceWriter::finalize() {
  m_outputFile->cd();
  m_outputTree->Write();
  m_outputFile->Close();
...
int ActsExamples::RootSingleSeedVertexPerformanceWriter::getNumberOfTruePriVertices(
