...
/// @class RootSingleSeedVertexPerformanceWriter
///
...
class RootSingleSeedVertexPerformanceWriter final
 ...
 public:
  ...
  RootSingleSeedVertexPerformanceWriter(const Config& config,
                                  Acts::Logging::Level level);

  ~RootSingleSeedVertexPerformanceWriter() override;
