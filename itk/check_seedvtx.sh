...
cp -v ../Examples/Algorithms/Vertexing/src/SeedVertexFinderAlgorithm.cpp SeedVertexFinderAlgorithm.cpp_version15
    ...
    for part in `echo $particle`
        ...
        for pT in `echo $minPT`
            ...
            for vtx in `echo $vtxX`
                ...
                mv -v itk_output/performance_seedvertexing.root performance_seedvertexing15_${numPart}_${part}_${pT}_${vtx}_${vtxY}_${vtxZ}.root 
            done
        done
    done
done
